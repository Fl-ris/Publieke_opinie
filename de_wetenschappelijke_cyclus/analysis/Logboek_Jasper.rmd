...
table_1 <- prop.table(table(Spiltsing_leeftijd$leeftijd_boven_onder_24[Spiltsing_leeftijd$leeftijd_boven_onder_24 == "boven"], Spiltsing_leeftijd$ouderszegenschap[Spiltsing_leeftijd$leeftijd_boven_onder_24 == "boven"]))
table_2 <- prop.table(table(Spiltsing_leeftijd$leeftijd_boven_onder_24[Spiltsing_leeftijd$leeftijd_boven_onder_24 == "onder"], Spiltsing_leeftijd$ouderszegenschap[Spiltsing_leeftijd$leeftijd_boven_onder_24 == "onder"]))
table_Man <- prop.table(table(Spiltsing_leeftijd$leeftijd_boven_onder_24[Spiltsing_leeftijd$geslacht == "Man"], Spiltsing_leeftijd$ouderszegenschap[Spiltsing_leeftijd$geslacht == "Man"]))
table_Vrouw <- prop.table(table(Spiltsing_leeftijd$leeftijd_boven_onder_24[Spiltsing_leeftijd$geslacht == "Vrouw"], Spiltsing_leeftijd$ouderszegenschap[Spiltsing_leeftijd$geslacht == "Vrouw"]))
...
##  27 mei 
Ik ga een chi square test doen.
```{r}

# Lijst van 1 en 0 maken voor Ja en Nee. 
abortus_minderjarig_keuze_01 <- ifelse(Spiltsing_leeftijd$leeftijd_boven_onder_24=="boven", 1, 0) # 1 voor de mensen de voorstander zijn, 0 als ze tegen zijn.

# Chi-square test:
chi_abortus_minderjarig_keuze_1 <- chisq.test(abortus$geslacht, abortus_minderjarig_keuze_01, correct = T)
chi_abortus_minderjarig_keuze_1

```
Uit deze chi square test kunnen we concluderen dat er geen significant verschil is tussen de mening van de mensen, van verschilde geslacht en onder de 25 over hun mening over of de ouders hun mening mee telt.
