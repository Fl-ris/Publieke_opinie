...
Omdat dit een etnische kwestie is, maar niet zo zwaar ligt als bijvoorbeeld vluchtelingen.<br>
...
En wat we achterkwamen was bijvoorbeeld over de bedenk tijd die veranderd is. Dus wel intersesaant om te kijken wat de menig er over is <br>

## 7 mei
Begonnen we met de enquête na alle goedkeuringen.
...
enquête open laten staan en allemaal meet waarden binnen krijgen en bedenken waar het nog meer hebben kunnen uit delen
...
Dit is echter niet waar want het getal is te klein om te zien namelijk 0.003084398. Daar zit dis een groot verschil in. Dit is ook wel logisch omdat de ouders vinden dat kinderen niet kunnen kiezen en de kinderen vinden dat de ouders er geen mening over mogen hebben. 
## 2 Juni 
Bezig gegaan met de paper met de introductie zodat het gedaan is en zorgt voor een  betere taalgebruik tijdens het schrijven.
## 3 juni 
