...
```{r}
#hier wordt een table gemaakt van het percentages van de antwoorden op het geheel
...
chi_leeftijd_kids_keuze <-chisq.test(Boven_onder_kidskeuze)
```
```{r}
Boven_onder_Wel_geen <-table(abortus_aangpast$leeftijd_boven_onder_24, abortus_aangpast$Vindt.u.dat.iemand.zelf.moet.kunnen.kiezen.of.die.een.abortus.wil.)
 chi_leeftijd_eigen_keuze <-chisq.test(Boven_onder_Wel_geen)
...
chi_leeftijd_vader_keuze <-chisq.test(Boven_onder_Vader)
```
## 30 mei 
...
```{r}
Boven_onder_Keuze_arbortus <-table(abortus_aangpast$leeftijd_boven_onder_24, abortus_aangpast$Vindt.u.dat.iemand.zelf.moet.kunnen.kiezen.of.die.een.abortus.wil.)
chi_leeftijd_keuze_Abortus <-chisq.test(Boven_onder_Keuze_arbortus)
```
```{r}
...
```{r}
chi_test_vector_leeftijd <- c(chi_leeftijd_keuze_Abortus[3],chi_leeftijd_keuze_verkrachting[3],chi_leeftijd_kids_keuze[3],chi_leeftijd_Ouderzegschap[3],chi_leeftijd_keuze_echo[3],chi_leeftijd_keuze_bedenktijd[3],chi_leeftijd_keuze_adoptie[3],chi_leeftijd_vader_keuze )
chi_test_vector_leeftijd
```
