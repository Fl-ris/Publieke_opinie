...
```{r }
abortus <- read.csv("/home/floris/Documenten/git_repo/Publieke_opinie/de_wetenschappelijke_cyclus/raw_data/abortus.csv",
                    na.strings = "NA")
abortus
```
...
plot(abortus$eigen_keuze_abortus)


cat(abortus$geloof)
 
#ggplot(abortus$geloof, aes(x=test, y=test2)) +
