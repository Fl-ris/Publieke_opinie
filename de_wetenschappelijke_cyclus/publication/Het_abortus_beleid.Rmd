...
```{r, warning=FALSE, message=FALSE, fig.cap='Vindt u dat adoptie een alternatief is voor abortus?', fig.asp=.75, out.width='50%', fig.align='left'}
...
```{r vader plot, warning=FALSE, message=F, fig.cap='Moet de biologische vader zeggenschap hebben over de beslissing voor een abortus?', fig.asp=.75, out.width='50%', fig.align='right'}
...
gezondheid_vrouw_plot_data <- data.frame(x2)
...
```{r echo plot, warning=FALSE, message=F, fig.cap='Antwoorden op de vraag:Vindt u dat er voor abortusgekozen mag worden als de vrouw niet in staat is voor het kind te zorgen vanwege financile beperkingen?'}
