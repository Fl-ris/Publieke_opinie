...
| Library naam: | Versie | Gebruikt voor: |
| --- | --- | --- |
| R | 4.4.0 (2024-04-24) | Visualisatie van hiërarchische data |
| ggraph | 2.2.1 | Circular packing grafieken |
| tidyverse | 2.0.0 | "%>% operator" |
| viridis | 0.6.5 | Kleur thema |
| ggplot2 | 3.5.1 | Alle ggplot grafieken |
| dplyr | 1.1.4 | Mutate(), select() en filter() |
| ggrepel | 0.9.5 | Pie-chart labels |
| ggridges | 0.5.6 | Ggridge density plot |
| pwr | 1.3.0 | Power analyse |
| gridExtra | 2.3 | Meerdere grafieken in een grid |
